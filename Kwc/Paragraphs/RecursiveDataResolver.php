<?php
class Kwc_Paragraphs_RecursiveDataResolver extends Kwf_Component_Generator_RecursiveDataResolver_Abstract
{
    public function getRecursive(array $generators, Kwf_Component_Select $select)
    {
        ...
        foreach ($this->_fetchRows($generators, $select) as $row) {
